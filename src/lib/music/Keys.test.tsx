import {requiredNotesForChord, toChord} from "@/lib/music/Chord";
import {toNote} from "@/lib/music/Note";
import {formatNotesInKey, getDiatonicChords, keyOf, KeyQuality, MAJOR_KEYS, symanticFormat} from "@/lib/music/Keys";
